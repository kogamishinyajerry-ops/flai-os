...
> 2026-07-21 修订：本 ADR 中“每个任务必须进入创建页亲手提交”的机械召集步骤，
> 已由 ADR-0031 在严格 safe_auto admission 范围内取代；ADR-0032 又在版本化
> `guide_dag.v1` 范围内开放 DAG 物化、附件来源绑定与跨刷新幂等。最终
> review/工程签发边界不变；本文其余正文保留为 M8 历史决策。
