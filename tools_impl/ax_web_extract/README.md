...
白名单，生产 Runtime 也不注入测试 witness。真实联网必须新增独立 L1 adapter，并在
可执行出站策略、角色授权和知识准入边界获批后交付。完整边界见
[`ADR-0030`](../../docs/adr/ADR-0030-ax-web-extract-subprocess-and-egress-boundary.md)。
